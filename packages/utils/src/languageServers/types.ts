/**
 * Editor-agnostic language-server contract shared by both Yasqe editors (`@zazuko/yasqe`,
 * Monaco-based, and `@zazuko/yasqe-codemirror`, CodeMirror 6-based).
 *
...
export interface LanguageServerDef<Y = any> {
   ...
   * per Yasgui tab). Defaults to an auto-generated unique URI.
   */
