...
If your app already has a dark-mode switch (Tailwind, VitePress, etc.), just call both lines from its change handler. The [hosted app](/) connects SparqlStudio's theme to the VitePress dark-mode toggle this way.
:::
