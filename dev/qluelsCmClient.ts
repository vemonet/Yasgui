...
import type { DeepPartial, Settings } from "@zazuko/yasgui-utils";
 ...
 * endpoint-powered entity completion (Yasgui's `onEndpointChange` does this for you, firing at
 * init for the active tab); without one you get keyword/variable completion only.
 *
